...
public class GroupMessengerProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        String filename = "";
        String value = "";
        //Log.e("GroupMessengerActivity", "Inside Content Provider Insert");
        filename = (String)values.get("key");
        value = (String)values.get("value");
        Log.e("GroupMessengerActivity", "Inserting Key = " + filename + " Value=" + value);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        //Log.e("GroupMessengerActivity", "Inside Content Provider Query");
        try {
        ...
        Log.e("GroupMessengerActivity", " Querying Key: "+ selection + "Value: "+ value);
        cursor.newRow().add(selection).add(value);
